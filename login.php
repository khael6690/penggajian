...
<head>
	...
	<link rel="stylesheet" href="<?= $fungsi->config()['url'] ?>/assets/compiled/css/auth.css" />
</head>
			...
			<div class="col-lg-5 col-12">
				<div id="auth-left">
					...
					<form method="post" class="text-center needs-validation" style="color: #757575;" novalidate>
						...
						<button name="submit" type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">
							Log in
						</button>
					</form>
				</div>
