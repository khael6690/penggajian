<div class="col-md-10">
	<div class="card">
		...
		<h5 class="card-header info-color white-text text-center py-4">
			<strong>Tambah Data Slip Gaji</strong>
		</h5>
		<br>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="md-form input-group mb-3">
							...
							<input type="number" id="gaji_pokok" name="gaji_pokok" class="form-control pendapatan" value="<?= $result[0]['gaji_pokok'] ?>" required>
		...
		<button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="submit" type="submit">Buat Slip Gaji</button>
		</form>
	</div>
